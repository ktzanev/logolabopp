...
%   \def\setdown{[shade, top color=bleuclaire, bottom color=bleufonce]}
%   \def\setborder{[draw=black]}
%   \def\setcircles{[draw=gray, thin]}
%   \def\settextlabo{[shade, top color=bleuclaire, bottom color=bleufonce]}
%   \def\settextheader{[text width=7cm, below right, gray, scale=0.84]}
%   \setlength{\destlen}{7cm}
%   \setlength{\explen}{7cm}
%
%  options \`a utiliser dans []
%   - draw=<color>
